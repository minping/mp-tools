package dbfKit.utils;

import dbfKit.constant.DBFStandardCharsets;
import dbfKit.enums.DBFAlignment;
...
public final class DBFUtils {
    ...
    public static long readLittleEndianInt2(DataInput in) throws IOException {
        long bigEndian = 0L;
        for (int shiftBy = 0; shiftBy < 32; shiftBy += 8) {
            long unsignedByte = in.readUnsignedByte();
            bigEndian |= (unsignedByte & 0xff) << shiftBy;
        }
        return bigEndian;
    }
