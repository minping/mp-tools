package dbfKit.pojo.bo;

import dbfKit.enums.DBFDataType;
import dbfKit.utils.DBFUtils;
...
public class DBFField {
    ...
    // For cloning
    public DBFField(DBFField origin) {
        super();
     ...
     */
    public static DBFField createField(DataInput in, Charset charset, boolean useFieldFlags, boolean supportExtendedCharacterFields) throws IOException {
...
//		}
    ...
    public static DBFField createFieldDB7(DataInput in, Charset charset, boolean supportExtendedCharacterFields) throws IOException {
...
//		}
     ...
     */
    public void write(DataOutput out, Charset charset) throws IOException {
        // Field Name
